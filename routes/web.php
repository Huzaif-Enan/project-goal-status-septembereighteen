...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('/project-status-index', [ProjectStatusController::class,'index'])->name('project-status-index');
    Route::get('/project-goal-details/{id}', [ProjectStatusController::class, 'projectGoalDetails'])->name('project-goal-details');
    Route::get('/status-request-form/{id}', [ProjectStatusController::class, 'statusRequestForm'])->name('status-request-form');
    Route::post('/manager-reason-event', [ProjectStatusController::class, 'managerReasonEvent'])->name('manager-reason-event');
    Route::get('/status-review-form/{id}', [ProjectStatusController::class, 'statusReviewForm'])->name('status-review-form');
    Route::post('/admin-review-event', [ProjectStatusController::class, 'adminReviewEvent'])->name('admin-review-event');
    Route::get('/extend-request-form/{id}', [ProjectStatusController::class, 'extendRequestForm'])->name('extend-request-form');
    Route::post('/extend-reason-event', [ProjectStatusController::class, 'extendReasonEvent'])->name('extend-reason-event');
    Route::get('/review-request-extend/{id}', [ProjectStatusController::class, 'reviewRequestExtend'])->name('review-request-extend');
    Route::post('/extend-review-event', [ProjectStatusController::class, 'extendReviewEvent'])->name('extend-review-event');
